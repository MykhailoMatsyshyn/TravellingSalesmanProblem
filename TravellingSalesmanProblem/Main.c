...
int main() {
    ...
    ///* 25 */
    //addCity(&graph, "Володимир-Волинський", 50.8484, 24.3232);
    //addCity(&graph, "Кам'янець-Подільський", 48.6843, 26.5809);
    ...
    //addCity(&graph, "Білгород-Дністровський", 46.1832, 30.3498);
    ...
    //addCity(&graph, "Корсунь-Шевченківський", 49.4213, 31.2531);
    //addCity(&graph, "Славута", 50.3019, 26.8655);
    //addCity(&graph, "Радомишль", 50.6147, 29.2643);
    //addCity(&graph, "Новоград-Волинський", 50.5956, 27.6160);
